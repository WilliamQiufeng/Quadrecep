...
namespace Quadrecep.Gameplay
{
    public class InputRetriever : Node
    {
        ...
        {
            var processor = APlayParent.InputProcessor;
            var time = APlayParent.Time;
        ...
        private static void EnqueueInputs(ref AInputProcessor processor, ref float time, string actionName, int key)
        {
